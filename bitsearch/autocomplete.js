var Autocomplete = function() {
    ...
    var i = function(t, e) {
      ...
      , u = function e() {
        ...
        n(this, "updateResults", (function(t) {
            ...
            i.onLoading(),
            i.search(t).then((function(t) {
                e === i.searchCounter && (i.results = t,
                i.onLoaded(),
                0 !== i.results.length ? (i.selectedIndex = i.autoSelect ? 0 : -1,
                i.onUpdate(i.results, i.selectedIndex),
                i.showResults()) : i.hideResults())
            }
            ))
        }
        )),
      ...
      , c = function() {
        function n(e, i, s) {
            t(this, n),
            this.id = "".concat(s, "-result-").concat(e),
            this.class = "".concat(s, "-result"),
            this["data-result-index"] = e,
            this.role = "option",
            e === i && (this["aria-selected"] = "true")
        }
        var i, s, o;
        return i = n,
        (s = [{
    ...
    return function e(i) {
        ...
        n(this, "initialize", (function() {
            ...
            s.resultList.id || (s.resultList.id = l("".concat(s.baseClass, "-result-list-"))),
            ...
            s.resultList.addEventListener("mousedown", s.core.handleResultMouseDown),
        ...
        n(this, "handleUpdate", (function(t, e) {
            ...
            s.input.setAttribute("aria-activedescendant", e > -1 ? "".concat(s.baseClass, "-result-").concat(e) : ""),
            s.resetPosition && (s.resetPosition = !1,
            s.position = r(s.input, s.resultList),
            s.updateStyle()),
        ...
        n(this, "updateStyle", (function() {
            ...
            "below" === s.position ? (s.resultList.style.bottom = null,
            s.resultList.style.top = "100%") : (s.resultList.style.top = null,
        ...
        x > 0 && (R.handleInput = d(R.handleInput, x)),
        this.core = R,
        this.initialize()
    }
}();
