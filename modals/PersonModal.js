    ...
    const getMovieInfo = async () => {
        try {
            ...
            let { data } = await axios.get(
                `${URLs[24]}person/${route.params.id}?api_key=${API_KEY}&language=en-US&append_to_response=images,movie_credits,tv_credits`
            );
            var images = [];
            setPersonData(data);
        ...
        >
            ...
            {isLoading ? (
                ...
                >
                    ...
                    <Image
                        source={require("../assets/images/loading-hand.gif")}
                            ...
                            {personData?.birthday ? (
                                <View style={styles.movieTextContainer}>
                                    <Text style={styles.movieText}>
                                        Born: {months[Number(personData.birthday.slice(5, 7)) - 1]}{" "}
                                        {personData.birthday.slice(8, 10)},{" "}
                                        {personData.birthday.slice(0, 4)}
                                    </Text>
                                </View>
                            ) : null}
                            {personData?.deathday ? (
                                <View style={styles.movieTextContainer}>
                                    <Text style={styles.movieText}>
                                        Died: {months[Number(personData.deathday.slice(5, 7)) - 1]}{" "}
                                        {personData.deathday.slice(8, 10)},{" "}
                                        {personData.deathday.slice(0, 4)}
                                    </Text>
                                </View>
                            ) : null}
                        ...
                        {personData?.movie_credits?.crew?.length > 0 ? (
                            <View style={[s.similarMovieContainer, s.imagesContainer]}>
                                ...
                                <FlatList
                                    ...
                                    showsHorizontalScrollIndicator={false}
                                    keyExtractor={(item) =>
                                        item.id.toString() + Math.round(Math.random() * 10000000)
                                    }
                                            ...
                                            <View style={styles.posterDetail}>
                                                ...
                                                {item.first_air_date ? (
                                                    <Text style={styles.posterYear}>
                                                        {
                                                            months[
                                                            Number(item.first_air_date.slice(5, 7)) - 1
                                                            ]
                                                        }{" "}
