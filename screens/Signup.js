...
export default function Signup({ navigation }) {
    ...
    const handleValidation = () => {
        ...
        if (
            ...
            if (name.length < 4) {
                ...
                setEmailError("");
                setPasswordError(
                    "You password must contain between 4 and 12 characters."
                );
            }
        }
    };
    const handleSubmit = async () => {
        try {
            Keyboard.dismiss();
            setIsLoading(true);
            let response = await axios.post(URLs[32], {
        ...
        <View style={[styles.container,{paddingTop:StatusBar.currentHeight}]}>
            ...
            <View style={s.container}>
                ...
                <View style={s.formContainer}>
                    ...
                    <View style={s.inputContainer}>
                        ...
                        <TextInput
                            style={[
                                s.input,
                                {
                                    backgroundColor: currentInput == 1 ? focusColor : normalColor,
                                },
                            ]}
                            ref={nameRef}
                            ...
                            autoCorrect={false}
                            onSubmitEditing={() =>
                                name.length > 4 ? emailRef.current.focus() : handleValidation()
                            }
                    ...
                    <View style={s.inputContainer}>
                        ...
                        <TextInput
                            style={[
                                s.input,
                                {
                                    backgroundColor: currentInput == 2 ? focusColor : normalColor,
                                },
                            ]}
                            ref={emailRef}
                            returnKeyType={password.length >= 4 ? "go" : "next"}
                    ...
                    <View style={s.inputContainer}>
                        ...
                        <TextInput
                            style={[
                                s.input,
                                {
                                    backgroundColor: currentInput == 3 ? focusColor : normalColor,
                                },
                            ]}
                            selectionColor={colors.lighterWhite}
                            ref={passwordRef}
                    ...
                    <Text style={[s.label, { textAlign: "center", marginTop: 20 }]}>
                        For queries contact
                        <TouchableHighlight
                            onPress={() =>
                                Linking.openURL("mailto:zflix.contact@protonmail.com")
                            }
                        >
                            <Text style={[s.label]}>zflix.contact@protonmail.com</Text>
                        </TouchableHighlight>
                    </Text>
                </View>
            </View>
